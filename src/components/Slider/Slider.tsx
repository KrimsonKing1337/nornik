...
import { Slide1, Slide2, Slide3, Slide4, Slide5, Slide6 } from './components';
...
export const Slider = () => {
  ...
  return (
    <div>
      ...
      <Slide5 ref={(el: HTMLDivElement) => setSectionRef(el, 4)} isActive={index === 4} />
      <Slide6 ref={(el: HTMLDivElement) => setSectionRef(el, 5)} isActive={index === 5} />
    </div>
  );
};
